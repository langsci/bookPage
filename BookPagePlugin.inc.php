	...
	function handleDisplay($hookName, $args) {
		...
		switch ($template) {
			case 'frontend/pages/book.tpl':
				...
				$plugin = PluginRegistry::getPlugin('generic', 'reviewstabplugin');
				if (is_a($plugin, 'ReviewsTabPlugin')) {
					// DAO to get reviews from database (data generated by reviews tab plugin)
